...
KeyboardApplication::KeyboardApplication()
    : Application(1024, 1024, "Keyboard project")
...
void KeyboardApplication::Initialize()
{
...
void KeyboardApplication::Update()
{
    Application::Update();
...
void KeyboardApplication::Render()
{
    Application::Render();
...
void KeyboardApplication::Cleanup()
{
    // Cleanup DearImGUI
    m_imGui.Cleanup();
...
Model KeyboardApplication::LoadModelWithShader(const char* vertPath, const char* fragPath)
{
...
void KeyboardApplication::InitializeModel()
{
...
void KeyboardApplication::InitializeCamera()
{
...
void KeyboardApplication::InitializeLights()
{
...
void KeyboardApplication::InitializeMaterials()
{
...
void KeyboardApplication::RenderGUI()
{
    m_imGui.BeginFrame();
...
void KeyboardApplication::UpdateCamera()
{
    Window& window = GetMainWindow();
